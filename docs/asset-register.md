...
| `Assets/_Game/Audio/Provided/` | `click.ogg`, `explosion.wav`, `congratulation.wav`, `gameover.wav` | User-provided bundle `Resources-20260906T110750Z-1-001` | Local source: `Resources/Audios_Musics/` | Not supplied; verify permission before distribution | UI click, detonation, victory and defeat feedback; generated tones remain fallback if an asset is unavailable. |
